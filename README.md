...
* [ACP](https://github.com/agentclientprotocol/agent-client-protocol) ![](https://img.shields.io/github/stars/agentclientprotocol/agent-client-protocol.svg?style=social) - The Agent Client Protocol (ACP) standardizes communication between code editors (interactive programs for viewing and editing source code) and coding agents (programs that use generative AI to autonomously modify code).
* [Agent Lightning](https://github.com/Lightning-AI/lightning-agents) ![](https://img.shields.io/github/stars/Lightning-AI/lightning-agents.svg?style=social) - Agent Lightning is a framework for building production-ready AI agents with Lightning AI.
...
* [AgentTorch](https://github.com/AgentTorch/AgentTorch) ![](https://img.shields.io/github/stars/AgentTorch/AgentTorch.svg?style=social) - AgentTorch is a framework for building and running Large Population Models (LPMs) that enables differentiable simulations over millions of autonomous agents.
...
* [any-agent](https://github.com/mozilla-ai/any-agent) ![](https://img.shields.io/github/stars/mozilla-ai/any-agent.svg?style=social) - any-agent is a Python library providing a single interface to different agent frameworks.
...
* [deepagents](https://github.com/langchain-ai/deepagents) ![](https://img.shields.io/github/stars/langchain-ai/deepagents.svg?style=social) - deepagents is a Python package that implements these in a general purpose way so that you can easily create a Deep Agent for your application.
* [EvoAgentX](https://github.com/EvoAgentX/EvoAgentX) ![](https://img.shields.io/github/stars/EvoAgentX/EvoAgentX.svg?style=social) - EvoAgentX is an open-source framework for building, evaluating, and evolving LLM-based agents or agentic workflows in an automated, modular, and goal-driven manner. 
...
* [Hephaestus](https://github.com/Ido-Levi/Hephaestus) ![](https://img.shields.io/github/stars/Ido-Levi/Hephaestus.svg?style=social) - Hephaestus is an open-source, semi-structured agentic framework where AI agents dynamically build workflows and tasks as they discover needs, instead of adhering to predefined plans.
...
* [n8n](https://github.com/n8n-io/n8n) ![](https://img.shields.io/github/stars/n8n-io/n8n.svg?style=social) - n8n is a workflow automation platform that gives technical teams the flexibility of code with the speed of no-code.
...
* [smolagents](https://github.com/huggingface/smolagents) ![](https://img.shields.io/github/stars/huggingface/smolagents.svg?style=social) - smolagents is a library that enables you to run powerful agents in a few lines of code. 
...
* [arcade-mcp](https://github.com/ArcadeAI/arcade-mcp one-liner) ![](https://img.shields.io/github/stars/ArcadeAI/arcade-mcp one-liner.svg?style=social) - arcade-mcp tool is a secure Python framework for building, authenticating, and deploying AI agent tools (MCP servers) at scale.
...
* [Graphiti](https://github.com/getzep/graphiti) ![](https://img.shields.io/github/stars/getzep/graphiti.svg?style=social) - Graphiti is a framework for building and querying temporally-aware knowledge graphs, specifically tailored for AI agents operating in dynamic environments.
* [LangMem](https://github.com/langchain-ai/langmem) ![](https://img.shields.io/github/stars/langchain-ai/langmem.svg?style=social) - LangMem provides ways to extract meaningful details from chats, store them, and use them to improve future interactions.
