...
* [claude-supermemory](https://github.com/supermemoryai/claude-supermemory) ![](https://img.shields.io/github/stars/supermemoryai/claude-supermemory.svg?cacheSeconds=86400) - claude-supermemory is a Claude Code plugin that gives AI persistent memory across sessions using Supermemory, enabling agents to remember work across sessions and projects with team memory and auto-capture features.
